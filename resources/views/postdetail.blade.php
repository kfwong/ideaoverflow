                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <button id="{{'comment-edit-'.$comment->id }}" type="button"
                                        class="close btn-delete-comment" data-toggle="tooltip" data-placement="bottom"
                                        title="Edit or Delete Comment"><span aria-hidden="true"><i
                                ...
                                <div class="media" id="comment-{{$comment->id}}">
                                    <div class="media-left">
                                        ...
                                        <div class="posts">
                                            <div class="jumbotron">
                                                @can('update', $post)
                                                <a href="/posts/{{$post->id}}/edit" class="close"
                                                   id="btn-edit-post"><span aria-hidden="true"><i
                                                                class="fa fa-pencil"></i></span></a>
                                                @endif
                                                <h1>{{ $post->title }}</h1>
                                                <h5>
                                            ...
                                            <div>
                                                <button class="btn btn-default btn-sm btn-like"
                                                        data-post-id="{{ $post->id }}" @cannot('like', App\Post::class) {{ 'disabled' }} @endcannot >
                                                    <span class="fa fa-thumbs-up"></span><span> Like </span>
                                                </button>

                                                @if($post->likes_count > 0)
                                                    <a href="" data-toggle="modal" data-target="#exampleModal"
                                                       data-post-id="{{$post->id}}">{{$post->likes_count}}
                                                        user{{$post->likes_count>1? 's like':' likes'}}
                                                        this post</a>
                                                @endif
                                                ...
                                                <div id="tags-container" class="hidden-xs">
                                                    <a class="btn btn-success btn-xs" href="">Idea</a>
                                                    <a class="btn btn-info btn-xs" href="">Web Development</a>
                                                    <a class="btn btn-warning btn-xs" href="">Environment
                                                        Conservation</a>
                                                </div>
                                            </div>
                            ...
                            <div class="modal fade" tabindex="-1" role="dialog"
                                 aria-labelledby="gridSystemModalLabel" id="exampleModal">
                                <div class="modal-dialog modal-sm" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="gridSystemModalLabel">Users who liked this
                                                post</h4>
                                        </div>
                                                        ...
                                                        @else
                                                            @foreach($post->comments as $comment)
                                                                <div class="panel panel-default">
                                                                    <div class="panel-body">
                                                                        @can('destroy', $comment)
                                                                        <button id="{{'comment-edit-'.$comment->id }}"
                                                                                type="button"
                                                                        ...
                                                                        <div class="media"
                                                                            ...
                                                                            <div class="media-body edit-comment">
                                                                                ...
                                                                                <div>
                                                                                    ...
                                                                                    btn-danger']) !!}
                                                                                    {!! Form::close() !!}
                                                                                    <a id="{{'cancel-comment-'.$comment->id}}"
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    ...
                                                                    <h4 class="modal-title"
                                                                        id="gridSystemModalLabel">Users who
                                                                        liked this post</h4>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="loader"></div>
